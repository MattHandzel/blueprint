...
export const KeyComboTagInternal = React.memo<KeyComboTagInternalProps>(function KeyComboTagInternal(props) {
    const { className, combo, minimal = false, platformOverride } = props;

    const getKeyIcon = React.useCallback(
        (key: string) => {
    ...
    const renderMinimalKey = React.useCallback(
