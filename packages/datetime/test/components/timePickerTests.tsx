...
describe("<TimePicker>", () => {
    ...
    it("should allow arrow buttons to loop time values", () => {
        render(
            <TimePicker
        ...
        userEvent.click(decrementHourBtn);

        assertTimeIs("23", "00", "59", "999");

        userEvent.click(decrementMinuteBtn);

        assertTimeIs("23", "59", "59", "999");

        userEvent.click(incrementSecondBtn);

        assertTimeIs("23", "59", "00", "999");

        userEvent.click(incrementMillisecondBtn);
    ...
    it("should respond to keyboard arrow presses", () => {
        ...
        userEvent.click(millisecondInput);
        userEvent.keyboard("{ArrowUp}");
    ...
    it("should respond to arrow button clicks", () => {
        ...
        userEvent.click(incrementHourBtn);
        assertTimeIs("1", "00", "00", "000");

        userEvent.click(incrementMinuteBtn);
        assertTimeIs("1", "01", "00", "000");
        ...
        userEvent.click(decrementSecondBtn);
        assertTimeIs("0", "00", "00", "001");

        userEvent.click(decrementMillisecondBtn);
        assertTimeIs("0", "00", "00", "000");
    });
    ...
    it("should not change value when disabled", () => {
        ...
        // Try arrow buttons
        userEvent.click(screen.getByLabelText<HTMLButtonElement>("Increase hours (24hr clock)"));
        expect(hourInput.value).to.equal("0");
    ...
    describe("Time range - minTime and maxTime props", () => {
        ...
        it("should allow any time to be selected by default", () => {
            ...
            userEvent.clear(hourInput);
            userEvent.type(hourInput, "12");
            userEvent.tab();
            userEvent.clear(minuteInput);
            userEvent.type(minuteInput, "30");
            userEvent.tab();
            ...
            userEvent.clear(hourInput);
            userEvent.type(hourInput, "23");
            userEvent.tab();
            userEvent.clear(minuteInput);
            userEvent.type(minuteInput, "59");
            userEvent.tab();
            userEvent.clear(secondInput);
            userEvent.type(secondInput, "59");
            userEvent.tab();
            userEvent.clear(millisecondInput);
            userEvent.type(millisecondInput, "999");
            userEvent.tab();
    ...
    describe("when uncontrolled", () => {
        ...
        it("should format input and change state when new value is typed", () => {
            ...
            userEvent.clear(minuteInput);
            userEvent.type(minuteInput, "8");
            userEvent.tab();

            // TimePicker does not auto-format single digits in this case
        ...
        it("should change input and state when arrow button is pressed", () => {
            render(<TimePicker showArrowButtons={true} />);
    ...
    describe("when controlled", () => {
        ...
        it("should not change input and state when arrow button is pressed", () => {
            const zeroDate = new Date(0, 0, 0, 0, 0, 0, 0);
...
function assertTimeIs(hours: string, minutes: string, seconds: string, milliseconds: string) {
    ...
    expect(hourInput.value).to.equal(hours);
    expect(minuteInput.value).to.equal(minutes);
    expect(secondInput.value).to.equal(seconds);
    expect(millisecondInput.value).to.equal(milliseconds);
}
